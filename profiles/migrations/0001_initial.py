    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('photo', models.ImageField(blank=True, null=True, upload_to='profiles/cropped_photos/')),
                ('photo_full', models.ImageField(blank=True, null=True, upload_to='profiles/full_photos/')),
                ...
                ('stackoverflow', models.CharField(blank=True, max_length=50, null=True)),
                ...
                ('description_label', models.CharField(default='About me', max_length=100)),
                ('skill_label', models.CharField(default='Skills', max_length=100)),
                ('language_label', models.CharField(default='Languages', max_length=100)),
                ('education_label', models.CharField(default='Education', max_length=100)),
                ('experience_label', models.CharField(default='Work experience', max_length=100)),
                ('certification_label', models.CharField(default='Certifications', max_length=100)),
                ('course_label', models.CharField(default='Courses', max_length=100)),
                ('honor_label', models.CharField(default='Honors and Awards', max_length=100)),
                ('organization_label', models.CharField(default='Organizations', max_length=100)),
                ...
                ('publication_label', models.CharField(default='Publications', max_length=100)),
                ('volunteering_label', models.CharField(default='Volunteering work', max_length=100)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='profile_set', to=settings.AUTH_USER_MODEL)),
            ],
        ),
        migrations.CreateModel(
            name='Volunteering',
            fields=[
                ...
                ('description', models.TextField(blank=True, max_length=1000, null=True)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='volunteering_set', to='profiles.profile')),
            ],
            options={
                'ordering': ('order', 'id'),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='skill_set', to='profiles.profile')),
            ],
            options={
                'ordering': ('-level',),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='resumes', to='profiles.profile')),
                ('resume_template', models.ForeignKey(null=True, on_delete=django.db.models.deletion.SET_NULL, to='texfiles.resumetemplate')),
            ],
        ),
        migrations.CreateModel(
            name='Publication',
            fields=[
                ...
                ('issuing_date', models.CharField(blank=True, max_length=20, null=True)),
                ...
                ('description', models.TextField(blank=True, max_length=1000, null=True)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='publication_set', to='profiles.profile')),
            ],
            options={
                'ordering': ('order', 'id'),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='project_set', to='profiles.profile')),
            ],
            options={
                'ordering': ('order', 'id'),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issuing_date', models.CharField(blank=True, max_length=100, null=True)),
                ('inventors', models.CharField(blank=True, max_length=200, null=True)),
                ('link', models.CharField(blank=True, max_length=100, null=True)),
                ('description', models.TextField(blank=True, null=True)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='patent_set', to='profiles.profile')),
            ],
            options={
                'ordering': ('order', 'id'),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField(blank=True, null=True)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='organization_set', to='profiles.profile')),
            ],
            options={
                'ordering': ('order', 'id'),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='language_set', to='profiles.profile')),
            ],
            options={
                'ordering': ('id', 'level'),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issuer', models.CharField(blank=True, max_length=100, null=True)),
                ('link', models.CharField(blank=True, max_length=100, null=True)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='honor_set', to='profiles.profile')),
            ],
            options={
                'ordering': ('order', 'id'),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('institution_link', models.CharField(blank=True, max_length=200, null=True)),
                ('start_date', models.CharField(blank=True, max_length=50, null=True)),
                ('end_date', models.CharField(blank=True, max_length=50, null=True)),
                ('description', models.TextField(blank=True, max_length=300, null=True)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='education_set', to='profiles.profile')),
            ],
            options={
                'ordering': ('order', 'id'),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('link', models.CharField(blank=True, max_length=100, null=True)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='course_set', to='profiles.profile')),
            ],
            options={
                'ordering': ('order', 'id'),
            },
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issuer', models.CharField(blank=True, max_length=100, null=True)),
                ('link', models.CharField(blank=True, max_length=100, null=True)),
                ('profile', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='certification_set', to='profiles.profile')),
            ],
            options={
                'ordering': ('order', 'id'),
            },
