...
\cvname{ \large{ {{ object.first_name }} {{ object.last_name }}}} % Your name
\cvjobtitle{ {{- object.jobtitle -}} } % Job title/career

\cvdate{ {{- object.date_of_birth -}} } % Date of birth
\cvaddress{ {{- object.location -}} } % Short address/location, use \newline if more than 1 line is required
\cvnumberphone{ {{- object.phone -}} } % Phone number
\cvsite{ {{- object.jobtitle -}} } % Personal website
...
\begin{twenty} % Environment for a list with descriptions
	{% for education in object.education_set.all() %}
		\twentyitem{ \small{ {{- education.start_date -}} - {{- education.end_date -}} }}
		{ {{- education.title -}} }
		{ \href{ {{- education.institution_link -}} }{ {{- education.institution -}} } }
