...
\name{ {{ object.firstname }} {{ object.lastname }} }
...
\highlightbar{
    ...
    % \section{Contact}
    {% if object.email_active %}\email{ {{- object.email -}} }{% endif %}
    {% if object.phone_active %}\phone{ {{- object.phone -}} }{% endif %}
    {% if object.location_active %}\location{ {{- object.location -}} }{% endif %}
    \vspace{0.5em}
    {% if object.website_active %}\website{ {{- object.website -}} }{ {{- object.website -}} }{% endif %}
    {% if object.skype_active %}\skype{ {{- object.skype -}} }{% endif %}
    {% if object.github_active %}\github{@GiantMolecularCloud}{https://github.com/giantmolecularcloud}{% endif %}
    {% if object.linkedin_active %}\linkedin{Nico Krieger}{https://www.linkedin.com/in/nico-krieger-6b28151b2/}{% endif %}
    \orcid{0000-0003-1104-2014}{https://www.orcid.org/0000-0003-1104-2014}

    \section{ {{- object.skill_label -}} }
